Gem::Specification.new do |s|
  s.name        = 'artisan_engine_listability'
  s.summary     = 'ArtisanEngine models are listable.'
  s.description = 'Gives ArtisanEngine models the ability to act as nested, ordered lists.'
